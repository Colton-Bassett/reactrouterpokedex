...
import {
	...
	fetchOnePokemonFromDB,
	savePokemonToDB,
	fetchRandomPokemonFromDB,
	fetchPokemonFromAPI,
} from "~/actions/actions";
import { PokemonCard, PokemonList } from "~/pokemon/pokemon";

// const pokemon = [
//   { id: 1, name: "Bulbasaur", type: "GrassPoison" },
//   { id: 25, name: "Pikachu", type: "Electric" },
//   { id: 49, name: "Venomoth", type: "BugPoison" },
//   { id: 72, name: "Tentacool", type: "WaterPoison" },
//   { id: 83, name: "Farfetch'd", type: "NormalFlying" },
//   { id: 102, name: "Exeggcute", type: "GrassPsychic" },
//   { id: 134, name: "Vaporeon", type: "Water" },
//   { id: 48, name: "Venonat", type: "BugPoison" },
...
export function HomePage({
	...
	return (
        ...
        {loaderData && (
          <ul>
            {loaderData.pokemonList!.map((p, index) => (
